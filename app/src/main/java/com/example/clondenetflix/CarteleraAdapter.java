    ...
    public void onBindViewHolder(@NonNull CarteleraAdapter.CarteleraViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pelicula.getTipo().equalsIgnoreCase("serie")) {
                    intent = new Intent(v.getContext(), DetalleSerieActivity.class);
                } else {
                    intent = new Intent(v.getContext(), DetallePeliActivity.class);
                }

                intent.putExtra("firebaseId", pelicula.getId());
